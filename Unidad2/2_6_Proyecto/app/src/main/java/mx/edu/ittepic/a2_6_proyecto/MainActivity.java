package mx.edu.ittepic.a2_6_proyecto;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        base = new BD(this);
        final List<Multa> multas = base.multas();
        size = multas.size();

        if(multas.size() > 0){
            multaView.setVisibility(View.VISIBLE);
            adapter = new MultaAdapter(this, multas );
        ...
        new ItemTouchHelper( new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
                adapter.deleteItem( multas.get( viewHolder.getAdapterPosition()).getId() );
            }
        }).attachToRecyclerView(multaView);
